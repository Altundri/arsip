          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pimpinan ><small>Edit Profil</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form  action="proses/proses_editprofile.php" method="post" enctype="multipart/form-data" name="formeditprofile" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <input type=hidden name="id_pimpinan" value="<?php echo $id;?>">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nama pimpinan <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['nama_pimpinan'];?>" type="text" id="nama_pimpinan" name="nama_pimpinan" required="required"  class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Username pimpinan <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input value="<?php echo $data['username_pimpinan'];?>" type="text" id="username_pimpinan" name="username_pimpinan" required="required" class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <img src="../pimpinan/images/<?php echo $data['gambar']; ?>" class="img-circle" height="80" width="80" style="border: 2px solid #666666;" /> 
                        </div>
                      </div>
