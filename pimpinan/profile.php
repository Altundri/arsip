          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pimpinan ><small>Profil Pimpinan</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <h3 align="center"><?php echo $data['nama_pimpinan']?></h3>
                    ...
                    <table class="table table-striped">
                      <tbody>
                        <tr>
                          <td width="50%">ID</td>
                          <td><?php echo $data['id_pimpinan']?></td>
                        </tr>
                        <tr>
                          <td>Nama pimpinan</td>
                        ...
                        <tr>
                          <td>Username Admin pimpinan</td>
                          <td><?php echo $data['username_pimpinan']?></td>
                        </tr>
