          ...
          <section class="login_content">
            <form action="proses_login.php" id="login" name="login" method="post">
              ...
              <div class="form-group has-feedback">
                <input type="text" id="username" name="username_pimpinan" class="form-control" autocomplete="off" maxlength="50" placeholder="Username" required="username" />
              ...
              <div class="separator">
                <div>
                  <<h2><img src="../../img/favicon.ico"> E-ARSIP PT. ULU MAS JAYA</h2>
                  <p>©2022 PT. ULU MAS JAYA</p>
                </div>
              </div>
            </form>
          </section>
